...
public class StrongDiamondTools {
	public static ToolItem STRONG_DIAMOND_SWORD = register("strong_diamond_sword", new SwordItem(JARMToolMaterials.STRONG_DIAMOND, 8, 7.0F, new Item.Settings().group(Main.JARM_GROUP)));
	public static ToolItem STRONG_DIAMOND_PICKAXE = register("strong_diamond_pickaxe", new PickaxeSubclass(JARMToolMaterials.STRONG_DIAMOND, 5, 5, new Item.Settings().group(Main.JARM_GROUP)));
