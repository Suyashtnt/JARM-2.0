...
public class RubyBiome extends Biome {
    ...
    RubyBiome() {
        ...
        this.addFeature(GenerationStep.Feature.LOCAL_MODIFICATIONS, other.RUBY_LIQUID_LAKE.configure(new SingleStateFeatureConfig(Blocks.RUBY_LIQUID.getDefaultState())).createDecoratedFeature(Decorator.WATER_LAKE.configure(new ChanceDecoratorConfig(40))));
